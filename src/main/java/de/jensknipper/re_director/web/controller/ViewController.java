...
public class ViewController {
    ...
    public String redirects(@RequestParam(required = false) String search,
    ...
    public String createRedirect(@ModelAttribute RedirectDto redirectDto, BindingResult bindingResult, Model model) {
        redirectRepository.create(redirectDto.getSource(), redirectDto.getTarget());
        return "redirect:/redirects";
    }

    @PostMapping("/redirects/{id}")
    public String updateRedirect(@PathVariable int id, @ModelAttribute RedirectDto redirectDto, BindingResult bindingResult, Model model) {

...
class RedirectRepositoryTest {
    ...
    void updateShouldChangeSourceAndTarget() {
        ...
        int id = redirectRepository.create("irrelevant", "irrelevant", Status.ACTIVE, RedirectHttpStatusCode.FOUND);
        int otherId =
            redirectRepository.create("irrelevant2", "irrelevant2", Status.ACTIVE, RedirectHttpStatusCode.FOUND);
    ...
    void deleteShouldDeleteSpecifiedRedirect() {
        ...
        String source = "source";
        String target = "target";
        int id = redirectRepository.create(source, target, Status.ACTIVE, RedirectHttpStatusCode.MOVED_PERMANENTLY);
        int otherId = redirectRepository.create("irrelevant", "irrelevant", Status.ACTIVE, RedirectHttpStatusCode.MOVED_PERMANENTLY);
    ...
    void findAllFilteredShouldListAllWhenNull() {
        // given
        redirectRepository.create("irrelevant", "irrelevant", Status.ACTIVE, RedirectHttpStatusCode.MOVED_PERMANENTLY);
        redirectRepository.create("irrelevant2", "irrelevant2", Status.ACTIVE, RedirectHttpStatusCode.MOVED_PERMANENTLY);
    ...
    void findAllFilteredShouldFindBySource() {
        ...
        String source = "source";
        String target = "target";
        redirectRepository.create(source, target, Status.ACTIVE, RedirectHttpStatusCode.MOVED_PERMANENTLY);
        redirectRepository.create("irrelevant", "irrelevant", Status.ACTIVE, RedirectHttpStatusCode.MOVED_PERMANENTLY);

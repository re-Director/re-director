...
import static de.jensknipper.redirector.redirects.test.TestRedirectService.LOCATION_HEADER;
...
import de.jensknipper.redirector.redirects.test.config.TestRedirectsProperties;
import java.net.URI;

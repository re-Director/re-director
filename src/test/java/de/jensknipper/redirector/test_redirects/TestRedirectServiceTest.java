...
import static de.jensknipper.redirector.test_redirects.TestRedirectService.LOCATION_HEADER;
...
import de.jensknipper.redirector.test_redirects.config.TestRedirectsProperties;
import java.net.URI;
